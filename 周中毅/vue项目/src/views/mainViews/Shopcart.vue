<template>
  <div v-if="isLogin">
    <van-list class="shopcart" v-model="loadOptions.isLoading" :finished="loadOptions.isFinished" :finished-text="loadOptions.finishedText" @load="loadData" :offset="50">
      ...
      <div v-if="shopcartData.length == 0">
        <van-empty description="购物车空空如也，逛一逛" image="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=3214428190,3968304704&fm=26&gp=0.jpg" />
      </div>
      <div v-else>
  ...
  <div v-else>
    <van-empty image="../../assets/images/logo.png" description="购物车空空如也，逛一逛"  />
  </div>
</template>
